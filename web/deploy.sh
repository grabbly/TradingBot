#!/bin/bash
# Установка и запуск Treddy Chart Service на сервере 192.168.1.3
...
echo "  - http://192.168.1.3:5001/health (локально)"
echo ""
echo "Логи сервиса:"
