...
На сервере Postgres (`192.168.1.3`):
...
PGPASSWORD=n8n_secure_pass_2024 python scripts/plot_ema.py --symbol NVDA --days 1 --output nvda_ema.png
```
...
- Подключи Metabase или Grafana к БД `trading_bot` на `192.168.1.3:5432`.
